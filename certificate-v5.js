(() => {
  ...
  async function downloadPdf(data, route, button) {
    ...
    try {
      ...
      doc.setTextColor(255, 255, 255); doc.setFont('helvetica', 'normal'); doc.setFontSize(8.5); doc.text('Autodiagnóstico orientativo · Guía interactiva · Role play aplicado · Plan personal de mejora', 34, 151);
