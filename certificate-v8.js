(() => {
  ...
  const ROUTES = [
    ...
    { code: 'pensamiento_critico', name: 'Pensamiento crítico, información y toma de decisiones', result: 'desarrolla-pensamiento-v1', keys: ['desarrolla-crit-learn-v1', 'desarrolla-crit-prebunk-v1', 'desarrolla-crit-role-v1', 'desarrolla-crit-plan-v1', 'desarrolla-crit-final-v2'], badge: 'pensamiento-critico.svg' },
  ...
  const PROGRAMS = {
    ...
    pensamiento_critico: ['Calidad de fuentes, evidencia y trazabilidad', 'Hechos, interpretaciones, supuestos y opiniones', 'Sesgos cognitivos aplicados a decisiones de SST', 'Prebunking y resiliencia informacional mediante Radar PREVER', 'IA, redes, proveedores y verificación de fuentes primarias', 'Causalidad, incertidumbre y explicaciones alternativas', 'Decisiones proporcionales basadas en evidencia'],
